...
Case study on Bright TV viewership data was received and uploaded for analysis to be conducted.

We checked the data for Bright TV; Viewership and userprofile so that we understand the background of the company.Detailed information was unpacked and used to analysis the comapany's current position.
